...
while True:
    ...
    nova_carta = comprar_cartas() #passando o retorno da funcão para reutilizar o valor

        
    
    if escolha == 1:
        comprar_cartas()
        print(f'Voce comprou: [{nova_carta[0]}]')
        valor_jogador += nova_carta[1]
        print('Suas cartas: ')
        for cartas in jogador:
...
'''
    ...
    if escolha == 2: # Mostrar naipe segunda [] sempre 0               
        ...
        if escolha_pc == 1: #dealer compra
             #remove a carta do baralho pra não ter repetições
